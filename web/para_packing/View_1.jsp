                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="position: absolute; left: 24px; top: 72px" title="Parachute Packing" width="100%">
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="10" sourceData="#{para_packing$View_1.para_packing_viewDataProvider}" sourceVar="currentRow">
                        ...
                        <webuijsf:button actionExpression="#{para_packing$View_1.add_action}" id="add" style="position: absolute; left: 24px; top: 48px" text="Add"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
