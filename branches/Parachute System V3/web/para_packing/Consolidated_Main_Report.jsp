    ...
    <f:view>
        <webuijsf:page id="page1">
            <webuijsf:html id="html1">
                <webuijsf:head id="head1" title="Consolidated Maintance Report">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:breadcrumbs id="breadcrumbs1" style="left: 14px; top: 14px; position: absolute">
                            ...
                            <webuijsf:hyperlink id="hyperlink3" text="para_packing/Consolidated_Main_Report" url="/faces/para_packing/Consolidated_Main_Report.jsp"/>
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="position: absolute; left: 24px; top: 96px" title="Table" width="97%">
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="10"
                                sourceData="#{para_packing$Consolidated_Main_Report.para_consolidated_viewDataProvider}" sourceVar="currentRow">
