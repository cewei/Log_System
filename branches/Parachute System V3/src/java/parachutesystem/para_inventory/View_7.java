 ...
 */
public class View_7 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        log("<<Entering para_inventory View_7>>");
        para_inventory_viewDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{para_inventory$View_7.para_inventory_viewRowSet}"));
        para_inventory_viewRowSet.setDataSourceName("java:comp/env/jdbc/parachute_system_MySQL");
        para_inventory_viewRowSet.setCommand("SELECT * FROM para_inventory_view WHERE `reserve_chute` = 0 AND `static_line` = 0 AND `lifejacket` = 0 AND `AD` = 0 AND `container` = 7");
