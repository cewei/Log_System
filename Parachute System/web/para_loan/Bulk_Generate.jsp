            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:upload binding="#{para_loan$Bulk_Generate.fileUpload1}" id="fileUpload1" label="Main" required="true" style="left: 24px; top: 72px; position: absolute"/>
                        ...
                        <webuijsf:upload binding="#{para_loan$Bulk_Generate.fileUpload2}" id="fileUpload2" label="Reserve" required="true" style="left: 24px; top: 120px; position: absolute"/>
