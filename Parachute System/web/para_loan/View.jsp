            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="position: absolute; left: 24px; top: 72px" title="Loans" width="0">
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="10" sourceData="#{para_loan$View.para_loan_viewDataProvider}" sourceVar="currentRow">
                                ...
                                <webuijsf:tableColumn headerText="Rank" id="tableColumn7" sort="para_loan_view.Rank">
                                    <webuijsf:staticText id="staticText7" text="#{currentRow.value['para_loan_view.Rank']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Borrower" id="tableColumn8" sort="para_loan_view.Borrower">
                                    <webuijsf:staticText id="staticText8" text="#{currentRow.value['para_loan_view.Borrower']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Unit" id="tableColumn9" sort="para_loan_view.Unit">
                                    <webuijsf:staticText id="staticText9" text="#{currentRow.value['para_loan_view.Unit']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Serial No" id="tableColumn1" sort="para_loan_view.Serial No">
                                    <webuijsf:staticText id="staticText1" text="#{currentRow.value['para_loan_view.Serial No']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Name" id="tableColumn2" sort="para_loan_view.Name">
                                    <webuijsf:staticText id="staticText2" text="#{currentRow.value['para_loan_view.Name']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Chute No" id="tableColumn3" sort="para_loan_view.Chute No">
                                    <webuijsf:staticText id="staticText3" text="#{currentRow.value['para_loan_view.Chute No']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Date Out" id="tableColumn4" sort="para_loan_view.Date Out">
                                    <webuijsf:staticText id="staticText4" text="#{currentRow.value['para_loan_view.Date Out']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn headerText="Date In" id="tableColumn5" sort="para_loan_view.Date In">
