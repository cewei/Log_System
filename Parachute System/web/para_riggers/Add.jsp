            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:label for="inspectorCB" id="label5" style="left: 24px; top: 168px; position: absolute" text="Inspector"/>
                        ...
                        <webuijsf:checkbox binding="#{para_riggers$Add.inspectorCB}" id="inspectorCB" selected="false" style="left: 168px; top: 168px; position: absolute"/>
                        <webuijsf:button actionExpression="#{para_riggers$Add.add_action}" id="add" style="left: 23px; top: 216px; position: absolute" text="Add"/>
                        ...
                        <webuijsf:calendar binding="#{para_riggers$Add.calendar1}" dateFormatPattern="dd-MM-yyyy" id="calendar1" label="Last Refresher Date"
                            required="true" style="left: 24px; top: 192px; position: absolute"/>
                        <webuijsf:message for="calendar1" id="message4" showDetail="false" showSummary="true" style="left: 336px; top: 192px; position: absolute"/>
                        <webuijsf:label id="label6" style="position: absolute; left: 24px; top: 144px" text="Checker"/>
                        <webuijsf:checkbox binding="#{para_riggers$Add.checkerCB}" id="checkerCB" style="position: absolute; left: 168px; top: 144px"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
