            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="left: 24px; top: 144px; position: absolute; width: 0px" title="Table" width="0">
                            <webuijsf:tableRowGroup binding="#{para_packing$Consolidated_Main_Edit.tableRowGroup1}" id="tableRowGroup1" rows="10"
                                ...
                                <webuijsf:tableColumn align="center" headerText="type_prefix_no" id="tableColumn1" valign="middle">
                                ...
                                <webuijsf:tableColumn headerText="date_packed" id="tableColumn6" sort="para_inventory.date_packed">
                        ...
                        <webuijsf:textField binding="#{para_packing$Consolidated_Main_Edit.inspectionTxt}" id="inspectionTxt" label="Type of Inspection" style="left: 24px; top: 48px; position: absolute"/>
                        <webuijsf:checkbox binding="#{para_packing$Consolidated_Main_Edit.repackCB}" id="repackCB" label="Repack" style="left: 288px; top: 48px; position: absolute"/>
                        <webuijsf:calendar binding="#{para_packing$Consolidated_Main_Edit.dateCal}" dateFormatPattern="dd-MM-yyyy" id="dateCal" label="Date" style="left: 384px; top: 48px; position: absolute"/>
                        <webuijsf:dropDown binding="#{para_packing$Consolidated_Main_Edit.packerDD}" id="packerDD"
                            ...
                            label="Packer" style="left: 24px; top: 72px; position: absolute"/>
                        <webuijsf:dropDown binding="#{para_packing$Consolidated_Main_Edit.inspectorDD}" id="inspectorDD"
                            ...
                            label="Inspector" style="left: 384px; top: 72px; position: absolute"/>
                        <webuijsf:button actionExpression="#{para_packing$Consolidated_Main_Edit.save_action}" id="save"
                            style="left: 23px; top: 120px; position: absolute" text="Save Changes"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
