                    ...
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:table augmentTitle="false" id="table1" style="left: 24px; top: 96px; position: absolute; width: 97%" title="Parachute Types" width="955">
                            <webuijsf:tableRowGroup binding="#{para_type$View.tableRowGroup1}" id="tableRowGroup1" rows="10"
                                ...
                                <webuijsf:tableColumn align="center" headerText="Static Line" id="tableColumn12" valign="middle">
                                    <webuijsf:staticText id="staticText12" text="#{currentRow.value['para_type.static_line']}"/>
                                </webuijsf:tableColumn>
                                ...
                                <webuijsf:tableColumn align="center" headerText="Life Jacket" id="tableColumn7" valign="middle">
                                    <webuijsf:staticText id="staticText7" text="#{currentRow.value['para_type.lifejacket']}"/>
                                </webuijsf:tableColumn>
                                <webuijsf:tableColumn align="center" headerText="AD" id="tableColumn10" valign="middle">
                                    <webuijsf:staticText id="staticText10" text="#{currentRow.value['para_type.AD']}"/>
                                </webuijsf:tableColumn>
