            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1" virtualFormsConfig="save | typePrefixText nameText lifeSpanText maxJumpText repackCycleText | typePrefixText nameText lifeSpanText maxJumpText repackCycleText">
                        ...
                        <webuijsf:label for="nameText" id="nameLbl" style="left: 24px; top: 96px; position: absolute" text="Name"/>
                        <webuijsf:label for="lifeSpanText" id="lifeSpanLbl" style="left: 24px; top: 144px; position: absolute" text="Life Span"/>
                        <webuijsf:label for="maxJumpText" id="maxJumpLbl" style="left: 24px; top: 192px; position: absolute" text="Max Jump"/>
                        <webuijsf:label for="repackCycleText" id="repackCycleLbl" style="left: 24px; top: 240px; position: absolute" text="Repack Cycle"/>
                        <webuijsf:textField binding="#{para_type$Add.typePrefixText}" id="typePrefixText" required="true" style="left: 120px; top: 48px; position: absolute"/>
                        <webuijsf:textField binding="#{para_type$Add.nameText}" id="nameText" required="true" style="left: 120px; top: 96px; position: absolute"/>
                        <webuijsf:textField binding="#{para_type$Add.lifeSpanText}" id="lifeSpanText" required="true" style="left: 120px; top: 144px; position: absolute"/>
