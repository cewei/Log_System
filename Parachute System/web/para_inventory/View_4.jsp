            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:button actionExpression="#{para_inventory$View_4.edit_action}" id="edit" style="position: absolute; left: 144px; top: 48px" text="Edit"/>
                        <webuijsf:table augmentTitle="false" id="table1" style="position: absolute; left: 24px; top: 72px" title="Parachute Inventory" width="1050">
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="10" sourceData="#{para_inventory$View_4.para_inventory_viewDataProvider}" sourceVar="currentRow">
