            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:button actionExpression="#{para_inventory$View_2.edit_action}" id="edit" style="left: 191px; top: 48px; position: absolute" text="Edit"/>
                        <webuijsf:table augmentTitle="false" id="table1" paginateButton="true" paginationControls="true"
                            ...
                            <webuijsf:tableRowGroup id="tableRowGroup1" rows="50" sourceData="#{para_inventory$View_2.para_inventory_viewDataProvider}" sourceVar="currentRow">
