 ...
 *
 * @version Edit_PackDue.java
 * @version Created on Jun 3, 2009, 10:51:46 AM
 * @author Dell
 */
public class Edit_PackDue extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        log("<<Entering para_packing Edit_PackDue>>");
        para_inventoryDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{para_packing$Edit_PackDue.para_inventoryRowSet}"));
        ...
        para_inventory_viewDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{para_packing$Edit_PackDue.para_inventory_viewRowSet}"));
        ...
        para_typeDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{para_packing$Edit_PackDue.para_typeRowSet}"));
    ...
    public String save_action() {
        try {
            ...
            log(" ERROR - para_packing.Edit : Error Description", ex);
